    ...
    <div class="root">
        ...
        <div class="container">
            ...
            <div class="section performance-by-questions">
                <span style="font-size:x-large; font-weight: bold; display:block; margin-bottom:8px;">Performance by
                    Questions</span>
                            ...
                            <span>
                                @if ($is_correct)
                                 ...
                                 <path stroke="blue" d="M9.999 13.587 7.7 11.292l-1.412 1.416 3.713 3.705 6.706-6.706-1.414-1.414z"></path>
                                    ...
                                    @endphp
                                    <img src="data:image/svg+xml;base64,{!! $svg !!}" height="10"
                                        width="10" style="float: right;" />
                                @else
                                    @php
                                 ...
                                 <path fill="none" stroke-linecap="round" stroke-linejoin="round" stroke="red" stroke-width="32" d="M320 320L192 192m0 128l128-128"></path>
                                    ...
                                    @endphp
                                    <img src="data:image/svg+xml;base64,{!! $svg !!}" height="0.5"
                                        width="0.5" style="float: right;" />
                                @endif
                            </span>
                        </div>
                    @endforeach
            ...
            <div class="section performance-by-topics">
                <span style="font-size:x-large; font-weight: bold; display:block; margin-bottom:8px;">Performance by
                    Topics</span>
                <span style="color:grey">Cards below shows student score in each topic compared to all (his/her
                    school's) students and (his/her country's) students.</span>
                <div class="data">
                    @foreach ($performance_by_topics as $array)
                        <div class="card">
                            ...
                            <div style="width:90%">
                                ...
                                @endphp
                                <img src="data:image/svg+xml;base64,{!! $svg !!}" height="0.6"
                                    width="0.6" style="float: right;" />
                            </div>
                            <hr width="100%">
                            <div style="width:90%">
                            ...
                            <div style="width:90%">
                                ...
                                @endphp
                                <img src="data:image/svg+xml;base64,{!! $svg !!}" height="0.25"
                                    width="0.25" style="float: right;" />
                            </div>
                        </div>
                    @endforeach
                </div>
                <div class="appendix" style="margin-top: 0">
                    <div>
                        <span class="appendix-span-title">
                            ...
                            @endphp
                            <img src="data:image/svg+xml;base64,{!! $svg !!}" height="0.5" width="0.5"
                                style="float: left;" />
                        </span>
                    ...
                    <div>
                        <span class="appendix-span-title">
                            ...
                            @endphp
                            <img src="data:image/svg+xml;base64,{!! $svg !!}" height="0.25" width="0.25"
                                style="float: right;" />
                        </span>
                        <span style="margin-left:20px">
            ...
            <div class="section">
                <span style="font-size:x-large; font-weight: bold; display:block; margin-bottom:8px;">Grade Performance
                    Analysis</span>
                <span style="color:grey">Table below shows student score in each topic compared to all his/her school's
                    students.</span>
            ...
            <div class="section">
                <p style="font-size:x-large; font-weight: bold; display:block; margin-bottom:8px;">Analysis By Question
                </p>
                <span style="color:grey">Table below shows student performance per question compared to all (his/her
                    school's) students and (his/her country's) students..</span>
                <table class="datatable">
                    <tr>
                        <th>Question</th>
