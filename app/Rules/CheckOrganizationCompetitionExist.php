...
class CheckOrganizationCompetitionExist implements Rule, DataAwareRule
{
    protected $message =[];
    protected $data;
    ...
    public function passes($attribute, $value)
    {
        ...
        $found = CompetitionOrganization::where(['competition_id' => $value,'organization_id' => $organization_id,'country_id' => $country_id])->count();
