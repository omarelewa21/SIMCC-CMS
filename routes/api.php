...
Route::group(["middleware" => ["cors", "auth:sanctum", "rolePermissions"]], function () {
    ...
    Route::group(["prefix" => "competition"], function () {
        ...
        Route::post("/verify/participants/send_verification_emails", [CompetitionController::class, "sendParticipantsVerificationEmails"])->name('competition.verify.participants.send_participants_verification_emails');
        Route::patch("/verify/participants/update", [CompetitionController::class, "updateParticipant"])->name('competition.verify.participants.update');
    });
